          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="https://wealthpark-lab.com/" target="_blank" className="text-sm text-gray-600 hover:text-[#1a1a1a] transition-colors inline-flex items-center gap-1">WealthPark研究所<svg width="12" height="12" viewBox="0 0 8 8" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M0.875 7.75C0.708333 7.75 0.5625 7.6875 0.4375 7.5625C0.3125 7.4375 0.25 7.29167 0.25 7.125V0.875C0.25 0.708333 0.3125 0.5625 0.4375 0.4375C0.5625 0.3125 0.708333 0.25 0.875 0.25H3.79167V0.875H0.875V7.125H7.125V4.20833H7.75V7.125C7.75 7.29167 7.6875 7.4375 7.5625 7.5625C7.4375 7.6875 7.29167 7.75 7.125 7.75H0.875ZM2.97917 5.45833L2.54167 5.02083L6.6875 0.875H4.41667V0.25H7.75V3.58333H7.125V1.3125L2.97917 5.45833Z"/></svg></Link></li>
