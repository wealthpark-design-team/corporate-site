...
export default function Header({ locale = 'ja' }: { locale?: string }) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - ヘッダーの下にメニューのみ表示 */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-16 z-40 bg-white">
          <div className="h-full overflow-y-auto flex flex-col">
            {/* メニューコンテンツ */}
            <ul className="flex-1 px-6 py-8 space-y-1">
              <li><Link href={`/${locale}/`} className="block py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors" onClick={() => setIsMenuOpen(false)}>Home</Link></li>

              <li>
                <button onClick={() => setOpenDropdown(openDropdown === 'news' ? null : 'news')} className="w-full text-left py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors flex items-center justify-between">
                  <span>ニュース</span>
                ...
                {openDropdown === 'news' && (
                  <ul className="pl-4 pb-2">
                    <li><Link href="https://wealth-park.com/ja/news/" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>ニュース</Link></li>
                    <li><Link href="https://wealth-park.com/ja/business/release-note" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>プロダクト新機能・改善</Link></li>
                    <li><Link href="https://prtimes.jp/main/html/searchrlp/company_id/40576" target="_blank" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>プレスリリース</Link></li>
                  </ul>
                )}
              </li>

              <li>
                <button onClick={() => setOpenDropdown(openDropdown === 'services' ? null : 'services')} className="w-full text-left py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors flex items-center justify-between">
                  <span>サービス</span>
                ...
                {openDropdown === 'services' && (
                  <ul className="pl-4 pb-2">
                    <li><Link href={`/${locale}/business`} className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>不動産管理会社向けサービス<br /><small>WealthParkビジネス</small></Link></li>
                    <li><Link href="https://owner-app.wealth-park.com" target="_blank" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>不動産オーナー向けサービス<br /><small>WealthParkオーナーアプリ</small></Link></li>
                    <li><Link href="https://wealthpark-ret.com/" target="_blank" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>海外不動産投資家向けサービス<br /><small>WealthPark RealEstate Technologies</small></Link></li>
                    <li><Link href="https://wealthpark-alt.com/" target="_blank" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>不動産関連の<br />クラウドファンディングサービス<br /><small>WealthPark Investment</small></Link></li>
                  </ul>
                )}
              </li>

              <li><Link href={`/${locale}/corporate/company`} className="block py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors" onClick={() => setIsMenuOpen(false)}>会社概要</Link></li>

              <li>
                <button onClick={() => setOpenDropdown(openDropdown === 'careers' ? null : 'careers')} className="w-full text-left py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors flex items-center justify-between">
                  <span>採用</span>
                ...
                {openDropdown === 'careers' && (
                  <ul className="pl-4 pb-2">
                    <li><Link href={`/${locale}/careers`} className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>中途採用</Link></li>
                    <li><Link href={`/${locale}/park`} className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>採用オウンドメディア「Park」</Link></li>
                  </ul>
                )}
              </li>

              <li>
                <button onClick={() => setOpenDropdown(openDropdown === 'articles' ? null : 'articles')} className="w-full text-left py-4 text-gray-900 text-lg font-medium hover:text-blue-600 transition-colors flex items-center justify-between">
                  <span>記事</span>
                ...
                {openDropdown === 'articles' && (
                  <ul className="pl-4 pb-2">
                    <li className="py-1 text-gray-500 text-xs font-bold">オウンドメディア</li>
                    <li><Link href="https://wealth-park.com/ja/wealthpark-blog/" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>WealthParkブログ</Link></li>
                    <li><Link href="https://wealthpark-lab.com" target="_blank" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>WealthPark研究所</Link></li>
                    <li><Link href={`/${locale}/park`} className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>採用オウンドメディア「Park」</Link></li>
                    <li className="py-1 text-gray-500 text-xs font-bold mt-2">特集</li>
                    <li><Link href="https://wealth-park.com/ja/business/seminar" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>イベント・セミナー</Link></li>
                    <li><Link href="https://wealth-park.com/ja/tag/keypersons-voice/" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>Key Person&apos;s Voice | 不動産管理会社のトップ対談</Link></li>
                    <li><Link href="https://wealth-park.com/ja/park_category/person/" className="block py-2 text-gray-600 text-sm" onClick={() => setIsMenuOpen(false)}>社員インタビュー</Link></li>
                  </ul>
                )}
              </li>
            </ul>
            ...
            <div className="border-t border-gray-200 p-6 space-y-4">
              <Link href={`/${locale}/business`} className="block py-3 px-6 border border-gray-300 text-gray-900 text-center text-base font-medium rounded-full hover:bg-gray-50 transition-colors" onClick={() => setIsMenuOpen(false)}>
                不動産管理会社の方
              </Link>
              <Link href="https://owner.wealth-park.com/" target="_blank" className="block py-3 px-6 bg-gray-900 text-white text-center text-base font-medium rounded-full hover:bg-gray-800 transition-colors" onClick={() => setIsMenuOpen(false)}>
                パソコン版WealthPark
              </Link>
